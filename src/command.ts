...
export function getCommands(): Commands {
  return {
    ...
    "goals": {
      name: "goals",
      usage: "goals [-v|create|edit|delete|history|backfill|wizard] [<name>] [<type>] [<measure>] [<presetName>]",
      examples: [
        "goals",
        "goals -v #verbose",
        "goals create",
    ...
    "presets": {
      name: "presets",
      usage: "presets [create|delete]",
      examples: [
        "presets",
        "presets create",
        "presets delete",
      ],
      description: "Get presets from your MonkeyType account, create or delete your presets from the DB",
